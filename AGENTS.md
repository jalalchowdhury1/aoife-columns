...
**8 levels** (`lib/levels/`), one ladder, 3 families on the home grid:
...
| 8 | `missing-digits` | the actual test format: hidden digits solved by "answer + bottom = top" check-adding |
